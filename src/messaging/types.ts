  ...
  gemini: [
    {
      ...
      badge: 'Latest',
      recommended: true,
      description: 'Google flagship flash model. Ultra-fast generation, sub-second latency, agentic.',
    },
    {
      id: 'gemini-3.7-flash',
      ...
      provider: 'gemini',
      badge: 'Fast',
      description: 'Agent-first flash model for technical writing and coding.',
    },
    {
      id: 'gemini-3.6-flash',
      ...
      provider: 'gemini',
      badge: 'Efficient',
      description: 'Optimized for high-efficiency token generation and fast edits.',
    },
    {
      id: 'gemini-3.5-flash',
      ...
      provider: 'gemini',
      badge: 'Fast',
      description: 'Google I/O 2026 flagship flash model with great speed.',
    },
    {
      ...
      provider: 'gemini',
      badge: 'Reasoning',
      description: 'High-reasoning effort preview model for complex STEM proofs.',
    },
    {
      id: 'gemini-2.5-flash',
      ...
      provider: 'gemini',
      badge: 'Fast',
      description: 'Reliable fast flash generation for quick phrasing.',
    },
    {
      id: 'gemini-2.0-flash',
      ...
      provider: 'gemini',
      badge: 'Efficient',
      description: 'Balanced speed and precision for iterative document drafting.',
    },
    {
      ...
      provider: 'gemini',
      badge: 'Fast',
      description: 'Sub-second lightweight responses.',
    },
  ],
  openai: [
    {
